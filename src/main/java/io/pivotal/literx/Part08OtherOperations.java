...
//========================================================================================
	...
	Flux<User> userFluxFromStringFlux(Flux<String> usernameFlux, Flux<String> firstnameFlux, Flux<String> lastnameFlux) {
        return Flux.zip(usernameFlux, firstnameFlux, lastnameFlux)
                .flatMap(tuple -> Flux.just(new User(tuple.getT1(), tuple.getT2(), tuple.getT3())));
    }

    // map is enough, no need for flatmap
    Flux<User> userFluxFromStringFlux0(Flux<String> usernameFlux, Flux<String> firstnameFlux, Flux<String> lastnameFlux) {
        Flux<Tuple3<String, String, String>> zip = Flux.zip(usernameFlux, firstnameFlux, lastnameFlux);
        Flux<User> map = zip
